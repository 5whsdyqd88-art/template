...
function QuoteCard({
  ...
  return (
    <motion.figure
      ...
      className="bg-white rounded-2xl shadow-card ring-1 ring-ink-100 p-6 md:p-8 min-h-[260px] flex flex-col gap-6 items-start hover:-translate-y-1 hover:shadow-cta hover:ring-primary-200 transition-all duration-200"
    >
