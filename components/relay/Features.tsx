...
export default function Features() {
  ...
  const MotionComponent = shouldReduceMotion ? "li" : motion.li;
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          {FEATURES.map((feature, index) => {
            ...
            return (
              <MotionComponent key={index} {...(shouldReduceMotion ? {} : entranceVariant)}>
                <Link
                  href={href}
                ...
                >
                  ...
                  <div className="mt-auto flex items-center text-sm text-primary-500 font-medium group-hover:translate-x-2 transition-transform duration-300 ease-out-soft">
                    Learn more
...
const FEATURES = [
  ...
  { icon: ShieldCheck, title: "Vouch", body: "Identity verification and 2FA with SMS, voice, and app-based authentication options.", href: "#" },
